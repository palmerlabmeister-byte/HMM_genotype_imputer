...
class HMMConfig:
    ...
    transition_model: Literal["stitch_parity", "factorized"] = "stitch_parity"
...
class PipelineConfig:
    ...
    snp_block_mode: Literal["exact_streaming", "independent_approx", "density_balanced_overlap"] = "exact_streaming"
