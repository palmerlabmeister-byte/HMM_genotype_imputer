...
def prepare_pedigree_table(
    ...
    *,
    ...
    sample_order = pd.DataFrame({"_pedigree_child_id": sample_ids, "_stitchv2_sample_order": np.arange(len(sample_ids))})
    ...
    out = out.sort_values("_stitchv2_sample_order").reset_index(drop=True)
    return out, cols
...
def curate_pedigree(
    ...
    *,
    ...
    # stitchv2 run with the default pedigree column arguments.
