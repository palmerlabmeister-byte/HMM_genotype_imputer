...
| Method | Overall R2 | F1 | Accuracy | ROC AUC | All-unsequenced R2 |
|---|---:|---:|---:|---:|---:|
| STITCHV2-off | 0.6723 | 0.7875 | 0.8082 | 0.9405 | 0.2473 |
| STITCHV2-smooth | 0.6376 | 0.8027 | 0.8223 | 0.9412 | 0.4208 |
| STITCHV2-kinship | 0.6781 | 0.7921 | 0.8128 | 0.9459 | 0.2662 |
| STITCHV2-transmission | 0.7376 | 0.8226 | 0.8418 | 0.9592 | 0.5001 |
| STITCH | -0.5538 | 0.3737 | 0.5274 | 0.6547 | -0.2363 |

Interpretation:

- `transmission` recovered the most information for animals with no reads.
- `smooth` helped unsequenced samples but reduced overall dosage R2 because it can over-smooth observed animals.
- `kinship` gave small stable gains and retained the best INFO among pedigree modes in that run.
- Original STITCH is a no-pedigree baseline here.
